...
public class Focus extends SupportedPage {
    ...
    public List<String> getRemovableElements() {
        ...
        removableElements.add("meta");
        removableElements.add(".Article-Overhead");
        removableElements.add(".Ad-Slot");
        removableElements.add(".LinksBox_Container");
        removableElements.add(".Boost-List-Article");
        removableElements.add(".Article-Comments-Button");
        removableElements.add(".LinkBox_ForDesktop");
        removableElements.add(".Ad-Carousel-Slider-Container");
        removableElements.add(".Ad-Carousel");
        removableElements.add(".Article-Comments-Overlay");
